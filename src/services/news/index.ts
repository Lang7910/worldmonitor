 ...
 * Summarization stays via existing edge functions (Groq/OpenAI/OpenRouter).
...
// Summarization (client-side with Ollama/Groq/OpenAI/OpenRouter/Browser T5 fallback)
